= Awesome Mcp Servers — User Quickstart
:toc: preamble
...
[source,bash]
----
git clone https://github.com/hyperpolymath/awesome-mcp-servers
...
* https://github.com/hyperpolymath/awesome-mcp-servers/issues — report bugs
