...
# Justfile for awesome-mcp-servers
...
doctor:
    @echo "Running diagnostics for awesome-mcp-servers..."
...
help-me:
    @echo "=== awesome-mcp-servers Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/awesome-mcp-servers/issues/new"
    @echo ""
...
# LLM context dump
llm-context:
    @echo "Project: awesome-mcp-servers"
